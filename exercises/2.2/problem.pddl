...
(:objects 
; BEGIN GENERATED ARTIFACT OBJECTS
    a1 a2 a3 b1 b2 c1 c2 - artifact
; END GENERATED ARTIFACT OBJECTS
...
; BEGIN GENERATED ARTIFACT INITIAL FACTS
...
(isheavy c1)
(isheavy c2)
; END GENERATED ARTIFACT INITIAL FACTS
...
(:goal (and
; BEGIN GENERATED ARTIFACT GOALS
    (indestination a1)
    (indestination a2)
    (indestination a3)
    (indestination b1)
